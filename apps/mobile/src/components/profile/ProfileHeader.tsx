/**
 * TAMVA ProfileHeader Component
 *
 * Header for the Financial Profile screen:
 * Displays title, supporting intelligence subtitle, privacy mask toggle shortcut,
...
export const ProfileHeader: React.FC<ProfileHeaderProps> = ({
  ...
  subtitle = 'Behavioural insights & consented standing',
}) => {
